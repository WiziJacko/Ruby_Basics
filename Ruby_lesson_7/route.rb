...
class Route
  ...
  SAME_STATIONS_ERROR = "Станция отправления и станция прибытия не могут быть одинаковыми"
  NOT_STATION_CLASS_ERROR = "Некорректный класс передаваемых параметров"
